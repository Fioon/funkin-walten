...
class Paths
{
	...
	inline static public function voicesPico(song:String):Any
	{
		var songKey:String = '${song.toLowerCase().replace(' ', '-')}/VoicesPico';
		var voicesPico = returnSound('songs', songKey);
		return voicesPico;
	}
