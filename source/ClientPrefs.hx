...
class ClientPrefs {
	...
	public static var squareRatio:Bool = false;
	public static var captions:Bool = true;
	public static var iconBounce:String = 'New Bounce';
	...
	public static var comboOffset:Array<Int> = [440, 230, 780, 340];
	...
	public static function saveSettings() {
		...
		FlxG.save.data.squareRatio = squareRatio;
		FlxG.save.data.captions = captions;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.squareRatio != null) {
			squareRatio = FlxG.save.data.squareRatio;
		}
		if(FlxG.save.data.captions != null) {
			captions = FlxG.save.data.captions;
		}
